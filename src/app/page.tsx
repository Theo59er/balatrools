...
function ToolCard({ name, description, Icon, href }:
    { name: string; description: string, Icon: React.FC<LucideProps> | IconType, href: string }) {
    return (
        <a href={href}
            className={
                `flex flex-row gap-4 items-center bg-primary-1 hover:bg-primary-2 
                p-4 rounded-lg shadow cursor-pointer text-white hover:text-white`
            }
        >
            <Icon size={48} />
...
export default function Home() {
    return (<div className="absolute-center w-1/2">
        ...
        <div className="flex flex-col gap-4 w-full">
            ...
            <ToolCard
                name="Library"
                description="A library with all jokers, consumables, and everything else you would need to know."
                Icon={Library}
                href="/wip"
            />
